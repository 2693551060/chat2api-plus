# chat2api-plus
**chat2api-plus** 用于将 Web 端的 ChatGPT 对话接口转换为标准的 OpenAI API 格式。本产品支持广泛的模型，包括免登录的 GPT-3.5、GPT-4、GPT-4-all、GPTS 和 GPT-4o。本项目配备了易于使用的管理仪表板，包括渠道管理、可视化数据显示以及批量添加或修改账户的功能。
